...
namespace HTMLConverter
{
    ...
    using Windows.UI.Xaml;    //using System.Windows.Documents; // TextElement
    ...
    public static class HtmlToXamlConverter
    {
        ...
        /// </returns>
        public static string ConvertHtmlToXaml(string htmlString, bool asRichTextBlock)
        {
            ...
            string rootElementName = asRichTextBlock ? HtmlToXamlConverter.Xaml_RichTextBlock : HtmlToXamlConverter.Xaml_Section;
            ...
            while (propertyEnumerator.MoveNext())
            {
                switch ((string)propertyEnumerator.Key)
                {
                    ...
                    case "font-size":
                        ...
                        break;
                    case "color":
                        xamlElement.SetAttribute(Xaml_Foreground, (string)propertyEnumerator.Value);
                        //SetPropertyValue(xamlElement, TextElement.ForegroundProperty, (string)propertyEnumerator.Value);
                        break;
                    case "background-color":
                        xamlElement.SetAttribute(Xaml_Background, (string)propertyEnumerator.Value);
        ...
        public const string Xaml_RichTextBlock = "RichTextBlock";
